...
import { Heart, Plus, RefreshCw, Search, Save, Ticket, UserRound } from 'lucide-react';
      ...
      <div className="rounded-3xl bg-white p-6 shadow-sm border border-stone-200">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-stone-600">Theo dõi điểm, hạng thành viên, lịch sử mua và voucher cho chuỗi chi nhánh.</p>
          </div>
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_420px]">
        ...
        <form onSubmit={save} className="rounded-3xl bg-white p-5 shadow-sm border border-stone-200">
          ...
          <div className="mt-4 rounded-2xl bg-stone-50 p-4 text-sm text-stone-600">
            <Ticket className="mb-2 h-5 w-5 text-amber-700" />
            Voucher và đổi điểm đã có API backend, bước tiếp theo là nối trực tiếp vào popup thanh toán POS.
          </div>
        </form>
      </div>
    </div>
