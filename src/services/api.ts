...
export const adminApi = {
  ...
  transferPosOrderTable: (id: string, targetTableId: string, reason?: string) =>
    api.post(`/admin/pos/orders/${id}/transfer-table`, { targetTableId, reason }).then(res => res.data),
  ...
  confirmPosKitchen: (orderId: string, printMode = 'PRINTED') =>
    api.post(`/admin/pos/orders/${orderId}/confirm-kitchen`, { printMode }).then(res => res.data),
  payPosOrder: (orderId: string, paymentMethod: string) =>
    api.post(`/admin/pos/orders/${orderId}/pay`, { paymentMethod }).then(res => res.data),
  getPosKitchenPrintLogs: (date?: string) =>
...
export const customerApi = {
  ...
  updateLoyaltySetting: (data: any) => api.put('/admin/customers/loyalty-setting', data).then(unwrapData),
  createTier: (data: any) => api.post('/admin/customers/tiers', data).then(unwrapData),
  updateTier: (id: string, data: any) => api.put(`/admin/customers/tiers/${id}`, data).then(unwrapData),
  deleteTier: (id: string) => api.delete(`/admin/customers/tiers/${id}`).then(res => res.data),
...
export const paymentApi = {
  ...
  getSupplierDebtSummary: (params?: any) => api.get('/admin/supplier-debts/summary', { params }).then(unwrapItems),
  createSupplierDebt: (data: any) => api.post('/admin/supplier-debts', data).then(unwrapData),
  paySupplierDebt: (data: any) => api.post('/admin/supplier-debts/pay', data).then(unwrapData),
